...
INSERT INTO USUARIO
                         (NOMBRES_USUARIO, APELLIDOS_USUARIO, ID_DEPARTAMENTO, ID_CARGO, UBICACION)
VALUES        (@NOMBRES_USUARIO,@APELLIDOS_USUARIO,@ID_DEPARTAMENTO,@ID_CARGO,@UBICACION)
...
INSERT INTO USUARIO
                         (NOMBRES_USUARIO, APELLIDOS_USUARIO, CI, ID_DEPARTAMENTO, ID_CARGO, UBICACION, N_EQUIPO)
VALUES        (@NOMBRES_USUARIO,@APELLIDOS_USUARIO,@CI,@ID_DEPARTAMENTO,@ID_CARGO,@UBICACION,@N_EQUIPO)
...
BEGIN
	INSERT INTO DEPARTAMENTO
                         (ID_DEPARTAMENTO, DESCRIPCION_DEPARTAMENTO)
VALUES        (@ID_DEPARTAMENTO, @DESCRIPCION_DEPARTAMENTO)
...
INSERT INTO CARGOS
                         (ID_DEPARTAMENTO, ID_CARGO, DESCRIPCION_CARGO)
VALUES        (@ID_DEPARTAMENTO, @ID_CARGO, @DESCRIPCION_CARGO)
...
INSERT INTO USUARIOGESTOR
                         (Nombres, Apellidos, CargoID, DepartamentoID, Estado, Usuario, Contraseña, PermisoID)
VALUES        (@Nombres,@Apellidos,@CargoID,@DepartamentoID,@Estado,@Usuario,@Contraseña,@PermisoID)
END
GO
...
BEGIN
UPDATE       DEPARTAMENTO
SET                DESCRIPCION_DEPARTAMENTO = @DESCRIPCIONDEPARTAMENTO
WHERE        (ID = @ID)
...
UPDATE       CARGOS
SET                ID_DEPARTAMENTO = @IDDEPARTAMENTO, DESCRIPCION_CARGO = @DESCRIPCIONCARGO
WHERE        (ID = @ID)
...
UPDATE       USUARIO
SET                NOMBRES_USUARIO =@NOMBRES_USUARIO, APELLIDOS_USUARIO =@APELLIDOS_USUARIO, CI =@CI, ID_DEPARTAMENTO =@ID_DEPARTAMENTO, ID_CARGO =@ID_CARGO, UBICACION =@UBICACION, N_EQUIPO =@N_EQUIPO
