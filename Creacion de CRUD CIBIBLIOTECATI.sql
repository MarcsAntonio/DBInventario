...
UPDATE       USUARIO
SET                NOMBRES_USUARIO =@NOMBRES_USUARIO, APELLIDOS_USUARIO =@APELLIDOS_USUARIO, CI =@CI, ID_DEPARTAMENTO =@ID_DEPARTAMENTO, ID_CARGO =@ID_CARGO, UBICACION =@UBICACION, N_EQUIPO =@N_EQUIPO, FECHA_ACTUALIZACION = @FechaModicacion
